...
public class Pipeline {
	...
	public void setJsonFolderLocation(String jsonFolderLocation) {
		this.jsonFolderLocation = jsonFolderLocation;
	}
	...
	public static Pipeline getPipelineFromConfigFile(String name,
		...
		// index configs
		pip.jsonFolderLocation = properties.getProperty("index.jsonFolderLocation");
