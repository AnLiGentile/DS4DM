...
//	}
//	
//	public void indexFilesFromFolderAndPersistJson(String path, ReadTableType tableType)
//			throws InterruptedException {
//		
//		List<String> files = FileUtils.readFilesFromFolder(path,
//				pipeline.getMaxFileSize());
...
//			// continue;
//			
//			IndexFileThreadAndPersistJson th = new IndexFileThreadAndPersistJson(pipeline, indexManager,
//					table, fileToTable, tableType, attributeIndexManager);
//			pipeline.getLogger().info("Indexing " + tCount + " table");
//			tCount++;
//			pool.execute(th);
...
//			try {
//
//				indexFilesFromFolderAndPersistJson((String) entry.getKey(),
//						(ReadTableType) entry.getValue());
//				// indexFilesFromFolderByValues((String) entry.getKey(),
//				// (ReadTableType) entry.getValue());
//			} catch (InterruptedException e) {
...
//		}
//
//		public void setAttributeIndexManager(
